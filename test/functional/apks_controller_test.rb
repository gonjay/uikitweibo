...
class ApksControllerTest < ActionController::TestCase
  ...
  test "should create apk" do
    assert_difference('Apk.count') do
      post :create, apk: { downloadUrl: @apk.downloadUrl, netType: @apk.netType, version: @apk.version }
    end
  ...
  test "should update apk" do
    put :update, id: @apk, apk: { downloadUrl: @apk.downloadUrl, netType: @apk.netType, version: @apk.version }
    assert_redirected_to apk_path(assigns(:apk))
  end
